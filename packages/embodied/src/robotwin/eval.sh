...
# records the model, thinking level, --max-turns, --time-limit and the units mode (--units,
# --stateless), and the summary covers only the requested cells and refuses to mix configurations.
set -uo pipefail
out=$1 tasks=$2
shift 2
