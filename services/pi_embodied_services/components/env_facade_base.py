...
class BaseEnvFacade(RpcFacade):
    ...
    State-caching principle:
        ...
        client side (see ``BaseEnvClient`` in ``pi_embodied_services.components.env_client_base.py``).
    ...
    EGL single-thread:
        ...
        (``pi_embodied_services.utils.rpc.main_thread_serve``) ahead of this class. It
